...
namespace MCCM.Entidad
{
    ...
    public partial class MCCMEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_listarCasos_Result> sp_listarCasos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_listarCasos_Result>("sp_listarCasos");
        }
    
        public virtual ObjectResult<sp_listarEntidadTelefono_Result> sp_listarEntidadTelefono(Nullable<int> caso)
        {
            var casoParameter = caso.HasValue ?
                new ObjectParameter("caso", caso) :
                new ObjectParameter("caso", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_listarEntidadTelefono_Result>("sp_listarEntidadTelefono", casoParameter);
        }
    }
}
